            ...
            <div class="row">
                <div class="form-group col-xs-6">
                    ...
                    <select class="form-control" name="clase" id="clase">
                      ...
                      <option value="4" <?php echo ($elalumno->clase == '4') ? 'selected' : ''; ?> >Víctimas del terrorismo</option>
                      <option value="5" <?php echo ($elalumno->clase == '5') ? 'selected' : ''; ?> >Víctima de violencia de género</option>
                      <option value="6" <?php echo ($elalumno->clase == '6') ? 'selected' : ''; ?> >Víctima de misiones de paz y seguridad</option>
                      <option value="8" <?php echo ($elalumno->clase == '8') ? 'selected' : ''; ?> >Familia Monoparental</option>
                      <option value="13" <?php echo ($elalumno->clase == '13') ? 'selected' : ''; ?> >Beneficiarios del Ingreso Mínimo Vital</option>
                      <option value="14" <?php echo ($elalumno->clase == '14') ? 'selected' : ''; ?> >Personas refugiadas o solicitantes de asilo</option>
                    </select>
                </div>
                <div class="form-group col-xs-6">
            ...
            <div class="row">
                <div class="form-group col-xs-3">
                    ...
                    <select class="form-control" name="mod" id="mod">
                      <option value="AP" <?php echo ($elalumno->mod == 'AP') ? 'selected' : ''; ?> disabled >Artes Plásticas, Imagen y Diseño</option>
                      <option value="CT" <?php echo ($elalumno->mod == 'CT') ? 'selected' : ''; ?> >Ciencias y Tecnología</option>
                      <option value="GE" <?php echo ($elalumno->mod == 'GE') ? 'selected' : ''; ?> disabled >General</option>
                      <option value="HS" <?php echo ($elalumno->mod == 'HS') ? 'selected' : ''; ?> >Humanidades y Ciencias sociales</option>
                      <option value="MA" <?php echo ($elalumno->mod == 'MA') ? 'selected' : ''; ?> disabled >Música y Artes Escénicas</option>
                    </select>
                </div>
                ...
                <div class="form-group col-xs-3">
                    <?php echo selectOptativaComun('Optativa común', 'opt' , $elalumno->opt); ?>
                </div>
                
                <div class="form-group col-xs-4">
                    <?php echo selectMateriaModalidad('Materia de modalidad (fase general)', 'matMod' , $elalumno->matMod); ?>
                </div>
            </div>
